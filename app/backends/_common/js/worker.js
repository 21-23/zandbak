...
function evaluate(task, puzzleContent) {
    try {
        var result = eval('(function(_, content, global, setTimeout, setInterval, self, location, navigator, onmessage, close, postMessage, importScripts) {"use strict"; return (function (arg) {' + task.input + '})(content);}).call(stub, stub, puzzleContent, stub, stubFun, stubFun, stub, stub, stub, stubFun, stubFun, stubFun, stubFun)');
